...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:/Users/User/OneDrive\Desktop/Coding/Face-recognition-based-automatic-attendance--main/FRAS/Images_GUI/bgReg.jpg")
    ...
    def reg(self):
            ...
            if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
                ...
                try:
                    ...
                    query=("select * from regteacher where email=%s")
