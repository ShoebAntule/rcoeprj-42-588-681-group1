...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"C:/Users/User/OneDrive/Desktop/Coding/Face-recognition-based-automatic-attendance--main/FRAS/Images_GUI/bg2.jpg")
        ...
        sub_combo["values"]=("Select Subject","M4","Python","MP","Topics in SE")
        sub_combo.current(0)
    ...
    def fetch_Data(self):
            conn = sq.connect(host="localhost",username="root",password="Ssa$18258p",database="face_recognition")
