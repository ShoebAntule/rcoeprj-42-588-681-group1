...
class Student:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1566x968+0+0")
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","Comps","AI&DS","ECS","Civil","Mech")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","M4","Py","Topics in SE","MP","DS","SE Economics","Arabic","PCE","English","Linear Algebra","Discrete Structures","DSA","Database","Software Construction","ToA","Info Security","Web")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2023-24")
...
# ==================Function Decleration==============================
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Ssa$182358p",database="face")
